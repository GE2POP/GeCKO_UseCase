...
samtools faidx Triticum_dicoccoides.WEWSeq_v.2.0.dna_with_scaffolds_20210617_names.fasta
sed -n '/chr/ p' Triticum_dicoccoides.WEWSeq_v.2.0.dna_with_scaffolds_20210617_names.fasta.fai | cut -f 1 > chr.lst
samtools faidx -r chr.lst Triticum_dicoccoides.WEWSeq_v.2.0.dna_with_scaffolds_20210617_names.fasta > Triticum_dicoccoides.WEWSeq_v.2.0.dna_20210617.fasta
