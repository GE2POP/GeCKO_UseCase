...
samtools faidx TriticTriticum_dicoccoides.WEWSeq_v.2.0.dna_with_scaffolds_20210617.fasta
sed -n '/chr/ p' Triticum_dicoccoides.WEWSeq_v.2.0.dna_with_scaffolds_20210617_names.fasta.fai |cut -f 1 >chr.lstsed -n '/chr/ p' Triticum_dicoccoides.WEWSeq_v.2.0.dna_with_scaffolds_20210617_names.fasta.fai |cut -f 1 >chr.lst
